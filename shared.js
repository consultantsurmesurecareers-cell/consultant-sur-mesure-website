// KORE GLOBAL ADVISORY - Shared JavaScript
...
const translations = {
    en: {
        ...
        testimonial_1: "KORE GLOBAL ADVISORY supported us with an experienced Clinical Research professional who integrated seamlessly into our ongoing study. <strong>Their understanding of regulatory standards and commitment to quality delivery truly strengthened our project execution.</strong>",
        ...
        testimonial_3: "KORE GLOBAL ADVISORY acts as a strategic partner rather than a traditional recruitment provider. <strong>Their continuous support, industry insight, and flexible collaboration model make them a trusted extension of our team.</strong>",
        ...
        story_text: "KORE GLOBAL ADVISORY was founded with a clear mission: to revolutionize how life sciences companies find and work with clinical research professionals. We built a boutique consulting firm focused on quality and long-term partnerships.",
        ...
        ceo_about_subtitle: "CEO & Founder – KORE GLOBAL ADVISORY",
        ...
        footer_all_rights: "© 2026 KORE GLOBAL ADVISORY – All Rights Reserved",
        footer_contact: "Contact",

        // MENTIONS LEGALES
        legal_title: "Mentions Légales",
        legal_company_label: "Company Name:",
        legal_company_value: "KORE GLOBAL ADVISORY",
        ...
        legal_address_value: "5 rue du Montant, 95280 Jouy-le-Moutier, France",
        ...
        legal_ip_text: "All content on this website (texts, graphics, logos, structure) is the exclusive property of KORE GLOBAL ADVISORY unless otherwise stated. Any reproduction, distribution, or use without prior written authorization is strictly prohibited.",

        // PRIVACY POLICY
        privacy_title: "Politique de Confidentialité",
        privacy_intro: "KORE GLOBAL ADVISORY is committed to protecting personal data in accordance with the General Data Protection Regulation (GDPR).",
        ...
        privacy_4_text: "Data submitted via forms is transmitted securely via email and stored only for processing purposes. Access to personal data is restricted to authorized personnel within KORE GLOBAL ADVISORY. Reasonable technical and organizational measures are implemented to protect data from unauthorized access, loss, or misuse.",
        ...
        privacy_7_text: "In accordance with GDPR, users have the right to:<ul><li>Access their personal data</li><li>Request correction</li><li>Request deletion</li><li>Restrict processing</li><li>Object to processing</li></ul>To exercise these rights, please contact: <a href=\"mailto:contact@consultantsurmesure.com\">contact@consultantsurmesure.com</a>. A response will be provided within the legally required timeframe.",
    ...
    fr: {
        ...
        testimonial_3: "KORE GLOBAL ADVISORY agit en tant que partenaire stratégique plutôt qu'un fournisseur de recrutement traditionnel. <strong>Leur soutien continu, leur connaissance du secteur et leur modèle de collaboration flexible en font une extension de confiance de notre équipe.</strong>",
        ...
        story_text: "KORE GLOBAL ADVISORY a été fondé avec une mission claire : révolutionner la façon dont les entreprises trouvent des professionnels de la recherche clinique. Nous avons bâti un cabinet axé sur la qualité.",
        ...
        ceo_about_subtitle: "CEO & Fondatrice – KORE GLOBAL ADVISORY",
        ...
        footer_all_rights: "© 2026 KORE GLOBAL ADVISORY – Tous droits réservés",
        footer_contact: "Contact",
        ...
        legal_ip_text: "Tout le contenu de ce site (textes, graphismes, logos, structure) est la propriété exclusive de KORE GLOBAL ADVISORY, sauf mention contraire. Toute reproduction, distribution ou utilisation sans autorisation écrite préalable est strictement interdite.",

        // PRIVACY POLICY
        privacy_title: "Politique de Confidentialité",
        privacy_intro: "KORE GLOBAL ADVISORY s'engage à protéger les données personnelles conformément au Règlement Général sur la Protection des Données (RGPD).",
        ...
        privacy_4_text: "Les données soumises via les formulaires sont transmises par email de manière sécurisée et stockées uniquement à des fins de traitement. L'accès aux données est limité au personnel autorisé de KORE GLOBAL ADVISORY. Des mesures techniques et organisationnelles raisonnables sont mises en œuvre pour protéger les données contre l'accès non autorisé, la perte ou l'utilisation abusive.",
        ...
        privacy_7_text: "Conformément au RGPD, les utilisateurs ont le droit de :<ul><li>Accéder à leurs données</li><li>Demander une rectification</li><li>Demander la suppression</li><li>Limiter le traitement</li><li>S'opposer au traitement</li></ul>Pour exercer ces droits, veuillez contacter : <a href=\"mailto:contact@consultantsurmesure.com\">contact@consultantsurmesure.com</a>. Une réponse sera apportée dans les délais légaux.",
        privacy_8_title: "8. Cookies",
